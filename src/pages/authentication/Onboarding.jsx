              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-white bg-primary11 rounded-md"
                  >
                    Add
                  </button>
                </div>
                ...
                {allergiesList.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {allergiesList.map((item, index) => (
                      <span
                        key={index}
                        className="flex items-center px-2 py-1 text-sm bg-purple-100 text-primary4 rounded-full"
                      >
                        {item}
                        <button
                          type="button"
                          onClick={() => handleRemoveAllergy(item)}
                          className="ml-2 text-primary11 hover:text-red-500"
                        >
                          ×
                        </button>
                      </span>
