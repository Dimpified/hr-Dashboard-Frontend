...
export const ButtonLongPurple = ({
  ...
  return (
    <button
      className={`${width} font-body h-14 rounded p-4 text-primary1 bg-primary11 opacity-80 hover:opacity-100 ${
        disabled ? "opacity-70" : "opacity-100"
      } ${className}`}
      onClick={onClick}
      type={type}
...
export const ButtonSmallWhite = ({
  ...
  return (
    <button
      className={`${width} font-body h-14 rounded p-${padding} text-primary4 bg-primary1 border border-primary11 opacity-80 hover:opacity-100 ${
        disabled ? "opacity-70" : "opacity-100"
      } ${className}`}
      onClick={onClick}
      type={type}
...
export const Button = ({ label, onClick }) => {
  return (
    <button
      className="bg-primary11 text-white px-3 py-1 rounded-md hover:cursor-pointer"
      onClick={onClick}
    >
      {label}
    </button>
