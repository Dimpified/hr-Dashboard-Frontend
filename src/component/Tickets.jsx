        ...
        <div className="flex flex-col space-y-5">
          <div className="flex items-center justify-between mt-4">
            <Text
              ...
              color="primary11"
              className="text-lg text-primary11"
            >
          ...
          <div className="rounded-lg">
            <div className="relative flex flex-col md:flex-row space-y-4 md:space-y-0 bg-primary11 items-center justify-between p-3 rounded-t-lg">
              <Text
                size=""
                weight="font-semibold"
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                  <div className="flex flex-col space-y-4 bg-primary1 rounded-lg w-auto h-64 p-7">
                    ...
                    <LongInputWithPlaceholder
                      ...
                      className="w-full mb-2 p-1 border rounded-xl focus:border-primary11"
                    ></LongInputWithPlaceholder>
